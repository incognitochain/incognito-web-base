...
import { getStorageLoadWalletError, setStorageLoadWalletError } from 'models/model/storageError';
import formatUtil from 'utils/format';
import storage from 'walletStorage';
...
async function initWallet(walletName = 'Wallet', rootName: string) {
  try {
