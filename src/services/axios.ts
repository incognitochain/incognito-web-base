...
const createAxiosInstance = ({ baseURL = '' }: { baseURL: string }) => {
  const instance = axios.create({
    ...
    timeout: TIMEOUT,
    headers: {
      Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..7cxDRHBslEJoqYC5raVv8lid66mjrmHpTCutAbBVkb4`,
      ...HEADERS,
    },
  });
