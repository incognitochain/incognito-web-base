import { IRootState, store } from '@src/app-redux';
import { ExternalLink, ThemedText } from '@src/components';
import { userAgent } from '@src/hooks';
...
function getRelevantState(): null | keyof IRootState {
