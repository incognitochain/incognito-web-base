...
import { getSearchURL } from 'pages/Blur/features/CollectionDetail';
import EthereumLogo from 'pages/Blur/images/ether.svg';
import React from 'react';

import { HEADER_LIST } from './Collection.constant';
import { CollectionItem } from './Collection.styled';
import { ILabel } from './Collection.types';
