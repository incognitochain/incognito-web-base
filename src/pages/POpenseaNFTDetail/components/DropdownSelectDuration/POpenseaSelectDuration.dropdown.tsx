...
export const Durations: Duration[] = [
  ...
  { title: 'Custom date', value: undefined },
];
...
interface POpenseaSelectDurationDropDownProps {
  selectedDuration?: number;
  onSelectDuration: (duration?: number) => void;
}

const POpenseaSelectDurationDropDown = (props: POpenseaSelectDurationDropDownProps) => {
...
export default memo(POpenseaSelectDurationDropDown);
