...
const GROUP_NETWORK: IGroupNetwork = {
  ETHEREUM: [PRIVATE_TOKEN_CURRENCY_TYPE.ETH, PRIVATE_TOKEN_CURRENCY_TYPE.ERC20],
  BSC: [PRIVATE_TOKEN_CURRENCY_TYPE.BNB, PRIVATE_TOKEN_CURRENCY_TYPE.BNB_BEP2, PRIVATE_TOKEN_CURRENCY_TYPE.BSC_BEP20], // TODO
  POLYGON: [PRIVATE_TOKEN_CURRENCY_TYPE.MATIC, PRIVATE_TOKEN_CURRENCY_TYPE.POLYGON_ERC20],
  FANTOM: [PRIVATE_TOKEN_CURRENCY_TYPE.FTM, PRIVATE_TOKEN_CURRENCY_TYPE.FANTOM_ERC20],
};
